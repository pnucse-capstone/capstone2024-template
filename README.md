...
* 조원 중에 한 사람이 본인 github 계정을 가지고 본인 조에 해당하는 github 레파지토리를 생성하세요. 이 때 이름은 "{학기}-{조번호}" 형식으로 생성하세요.
* 예를 들어, 2024년도 1학기(전기) 3조는 "1-03"로 이름을 입력하시면 "capstone2024-1-03"이란 이름으로 레파지토리가 생성됩니다.
